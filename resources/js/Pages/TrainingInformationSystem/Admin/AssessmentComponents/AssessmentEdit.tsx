    ...
    return (
        <div className='flex-1 flex flex-col gap-y-2.5 overflow-y-auto relative'>
            ...
            <div className='flex-1 overflow-y-auto'>
                ...
                {!!questions&&(
                    <Accordion defaultValue={!!questions[0]?questions[0].id.toString():undefined} type="single" collapsible className="w-full">                    
                        {(questions||[]).map((question,idx)=> <AssessmentQuestionItem key={question.id} question={question} index={idx} />)}                        
                    </Accordion>
                )}
            </div>
        </div>
